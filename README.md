...
Estimates the full probability distribution of the sample mean of Bernoulli random variables using a combination of direct Monte Carlo sampling and importance sampling with exponential bias weights. This approach efficiently recovers the distribution in the tails where direct sampling would be prohibitively expensive. For details on the method see: L. Münster, A. K. Hartmann and M. Weigel, Phys. Rev. E 110, 054112 (2024), https://doi.org/10.1103/PhysRevE.110.054112 
